...
const categoryOptions = [
  'App Crash or Freezing',
  'GPS or Navigation Issue',
  'Login / Authentication Problem',
  'Camera or QR Scanner Bug',
...
export const TechnicalSupportScreen: React.FC<TechnicalSupportScreenProps> = ({ onBack }) => {
  ...
  const handleSubmit = () => {
    ...
    Alert.alert(
      'Ticket Submitted',
      `Your technical support ticket has been submitted.\n\nCategory: ${selectedCategory}\n\nOur tech team will review this within 24 hours.`,
      ...
      >
        ...
        >
          <Animated.View style={{ opacity: contentFadeAnim }}>
            <Text style={styles.mainHeading}>Report a Bug</Text>
            <Text style={styles.mainSubtitle}>
              Having trouble with the application? Report the technical glitch so our engineers can patch it.
            </Text>
            ...
            <Animated.View style={[styles.formFieldBlock, getStaggerStyle(0)]}>
              ...
              <TouchableOpacity
                accessible={true}
                accessibilityLabel={selectedCategory ? `Selected type: ${selectedCategory}` : 'Select issue type'}
            ...
            <Animated.View style={[styles.formFieldBlock, getStaggerStyle(1)]}>
              <Text style={styles.fieldLabel}>Provide Details</Text>
              <TextInput
                placeholder="Tell us what happened, steps to reproduce, or error messages..."
            ...
            <Animated.View style={[styles.formFieldBlock, getStaggerStyle(2)]}>
              ...
              <View style={styles.uploadCardsRow}>
                ...
                <Animated.View style={{ transform: [{ scale: card1Scale }] }}>
                  <TouchableOpacity
                    accessible={true}
                    accessibilityLabel="Take screenshot photo"
                    accessibilityRole="button"
                    activeOpacity={0.85}
                  ...
                  >
                    <View style={styles.uploadIconCircle}>
                      <CameraIcon size={20} color="#7C4DFF" />
                    </View>
                    <Text style={styles.uploadBtnHeading}>Take Screenshot</Text>
                ...
                <Animated.View style={{ transform: [{ scale: card2Scale }] }}>
                  <TouchableOpacity
                    accessible={true}
                    accessibilityLabel="Upload file screenshot"
                    accessibilityRole="button"
                    activeOpacity={0.85}
            ...
            >
              <TouchableOpacity
                accessible={true}
                accessibilityLabel="Submit technical bug report"
                accessibilityRole="button"
